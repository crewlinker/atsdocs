...
- <br />Don't expose API keys in client-side applications.<br />
- <br />Don't include API keys in public source code.<br />
- <br />Don't commit API keys to Git repositories.<br />
- <br />Use environment variables or a secrets manager to store keys.<br />
- <br />Use separate API keys for separate integrations when appropriate.<br />
- <br />Revoke keys that are no longer needed.<br />
- <br />Revoke a key immediately if you believe it has been exposed.<br />
