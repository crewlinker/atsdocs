...
2. Go to **Settings → My account → API Keys**. <img src="/images/37.png" alt="37" title="37" lightAlt="Personal API keys" darkAlt="Personal API keys" />
3. Click **Create API key**. <img src="/images/Screenshot-2026-09-25-at-13.51.31.png" alt="Screenshot 2026 09 25 At 13 51 31" title="Screenshot 2026 09 25 At 13 51 31" lightAlt="Create-API-key" darkAlt="Create-API-key" />
